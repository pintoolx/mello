    ...
    sections: [
      {
        ...
        content: (
          <>
            <p>
              在「採購申請」選擇「新增採購申請」。填入查詢企業名稱、預算上限及選填的補充需求。目前服務類型限於企業信用風險報告。
            </p>
            <p>
              公司抬頭、統一編號與成本中心來自公司設定。建立申請會保存原始需求與案件編號，但不會立即付款。
            </p>
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              在案件詳情核對原始需求，再選擇「送出採購」。系統開始解析需求、取得供應商候選、檢查政策並執行核准的採購。
            </p>
            <p>
